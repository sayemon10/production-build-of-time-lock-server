...
let ServersService = ServersService_1 = class ServersService {
    serversRepository;
    logger = new common_1.Logger(ServersService_1.name);
    servers = [];
    constructor(serversRepository) {
...
], ServersService.prototype, "setServers", null);
ServersService = ServersService_1 = __decorate([
